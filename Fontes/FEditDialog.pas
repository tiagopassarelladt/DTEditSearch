...
begin
  ...
  begin
        if ( QrySearch.Fields[I].DataType = ftFloat ) OR
           ( QrySearch.Fields[I].DataType = ftCurrency ) OR
           ( QrySearch.Fields[I].DataType = ftFMTBcd ) then
        begin
            QrySearch.Edit;
  ...
  Panel2.Caption := QrySearch.RecordCount.ToString + ' - Registros';
end;
